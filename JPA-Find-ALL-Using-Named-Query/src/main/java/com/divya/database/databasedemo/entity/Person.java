...
//This is used to find all data from entity. But here in query
// Person --> refers to class name not table. Because named query
//doesnt pick data from table instead it picks from entity.
